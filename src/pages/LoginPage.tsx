      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-navy-900 to-navy-800 px-8 py-10 text-center">
            <div className="w-16 h-16 bg-brand rounded-2xl flex items-center justify-center mx-auto mb-4 text-white text-2xl font-bold shadow-lg">G</div>
            <h1 className="text-white text-2xl font-bold">Comité de Producto</h1>
            <p className="text-gray-400 text-sm mt-1">Global81 SpA · Sistema de Gobierno</p>
          </div>
          ...
          <div className="px-8 py-8 space-y-6">
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 hover:border-brand text-gray-700 font-medium py-3 px-4 rounded-xl transition-all hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
